...
RecvRequestVoteResponse(m) ==  \* func: doProcessRequestVoteResult
    ...
    IN IF resp.term > current_term[dst]
       ...
       ELSE IF state[dst] /= Candidate
            THEN /\ UNCHANGED noNetVars
                 /\ NetUpdate2(NetDelMsg(m), <<"RecvRequestVoteResponse", "not candidate", dst, src>>)
...
\* Last modified Thu Apr 27 15:51:36 CST 2023 by tangruize
