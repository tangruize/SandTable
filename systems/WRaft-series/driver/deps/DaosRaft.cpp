...
extern "C" {
#include "deps/DaosRaft/include/raft.h"
#include "deps/DaosRaft/include/raft_log.h"
#include "deps/DaosRaft/include/raft_private.h"
}
...
typedef msg_installsnapshot_t raft_snapshot_req_t;
...
raft_cbs_t raft_cbs = {
        ...
        .send_installsnapshot = raft_send_installsnapshot,
        .recv_installsnapshot = raft_recv_installsnapshot,
        .recv_installsnapshot_response = raft_recv_installsnapshot_response,
...
//        cerr << "RAFT LOG COUNT: " << raft_log_count(log) << endl;
        ...
        for (int i = 0; i < me->num_nodes; i++) {
            ...
            if (raft_node_get_id(n) == me->node_id)
                continue;
